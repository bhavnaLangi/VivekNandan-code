                ...
                return function(t, e, n, a) {
                    var r, o, i, l, s = function(e) {
                            this.$ = function(t, e) {
                                ...
                                return new o(t ? le(this[r.iApiIndex]) : this)
                            ...
                            return this.each((function() {
                                ...
                                if ("table" == this.nodeName.toLowerCase()) {
                                    ...
                                    var D = m.oLanguage;
                                    t.extend(!0, D, o.oLanguage), D.sUrl ? (t.ajax({
                                        dataType: "json",
                                        url: D.sUrl,
                                        success: function(e) {
                                            F(e), I(d.oLanguage, e), t.extend(!0, D, e), he(m, null, "i18n", [m]), Nt(m)
                                        },
                                        error: function() {
                                            Nt(m)
                                        }
                                    }), f = !0) : he(m, null, "i18n", [m]), null === o.asStripeClasses && (m.asStripeClasses = [S.sStripeOdd, S.sStripeEven]);
                                    var _ = m.asStripeClasses,
                                        T = h.children("tbody").find("tr").eq(0); - 1 !== t.inArray(!0, t.map(_, (function(t, e) {
                                        return T.hasClass(t)
                                    ...
                                    if (V(m, o.aoColumnDefs, w, (function(t, e) {
                                            O(m, t, e)
                                        })), T.length) {
                                        var A = function(t, e) {
                        ...
                        v = function(t, e) {
                            return u[e] || (u[e] = new RegExp(Ct(e), "g")), "string" == typeof t && "." !== e ? t.replace(/\./g, "").replace(u[e], ".") : t
                        },
                        m = function(t, e, n) {
                    ...
                    function R(t) {
                        L(t, "orderable", "bSortable"), L(t, "orderData", "aDataSort"), L(t, "orderSequence", "asSorting"), L(t, "orderDataType", "sortDataType");
                        var e = t.aDataSort;
                    ...
                    function U(t) {
                        ...
                        for (e = 0, n = d.length; e < n; e++)
                            ...
                            for (r = 0, o = p.length; r < o; r++) {
                                for (i = 0, l = h.length; i < l && (f[i] === a && (f[i] = G(t, i, e, "type")), (c = p[r](f[i], t)) || r === p.length - 1) && ("html" !== c || g(f[i])); i++);
                                if (c) {
                                    u.sType = c;
                                    break
                                }
                    ...
                    function J(e, n) {
                        ...
                        return n instanceof t || (n = t(n)), n.map((function(t, n) {
                            return a = rt(e, n), X(e, a.data, n, a.cells)
                        }))
                    }
                    ...
                    function ot(e, a, r, o) {
                        var i, l, s, u, c, f, d = e.aoData[a],
                            ...
                            p = [];
                        if (null === d.nTr) {
                            for (i = r || n.createElement("tr"), d.nTr = i, d.anCells = p, i._DT_RowIndex = a, it(e, d), u = 0, c = e.aoColumns.length; u < c; u++) s = e.aoColumns[u], (l = (f = !r) ? n.createElement(s.sCellType) : o[u])._DT_CellIndex = {
                                row: a,
                                column: u
                            }, p.push(l), !f && (!s.mRender && s.mData === u || t.isPlainObject(s.mData) && s.mData._ === u + ".display") || (l.innerHTML = G(e, a, u, "display")), s.sClass && (l.className += " " + s.sClass), s.bVisible && !r ? i.appendChild(l) : !s.bVisible && r && l.parentNode.removeChild(l), s.fnCreatedCell && s.fnCreatedCell.call(e.oInstance, l, G(e, a, u), h, a, u);
                    ...
                    function lt(e) {
                        ...
                        if (u && dt(e.aoHeader, l), t(l).children("tr").attr("role", "row"), t(l).children("tr").children("th, td").addClass(c.sHeaderTH), t(s).children("tr").children("th, td").addClass(c.sFooterTH), null !== s) {
                            var d = e.aoFooter[0];
                        ...
                        if (-1 === t.inArray(!1, r)) {
                            ...
                            if (0 !== d.length)
                                for (var g = f ? 0 : h, b = f ? e.aoData.length : p, v = g; v < b; v++) {
                                    ...
                                    1 == e.iDraw && "ajax" == be(e) ? _ = u.sLoadingRecords : u.sEmptyTable && 0 === e.fnRecordsTotal() && (_ = u.sEmptyTable), o[0] = t("<tr/>", {
                                        class: s ? l[0] : ""
                                    }).append(t("<td />", {
                                        valign: "top",
                                        colSpan: E(e),
                    ...
                    function pt(e, n, a) {
                        ...
                        var f = {
                            ...
                            error: function(n, a, r) {
                                var o = he(e, null, "xhr", [e, null, e.jqXHR]); - 1 === t.inArray(!0, o) && ("parsererror" == a ? se(e, 0, "Invalid JSON response", 1) : 4 === n.readyState && se(e, 0, "Ajax error", 7)), Bt(e, !1)
                            }
                        };
                        e.oAjaxData = n, he(e, null, "preXhr", [e, n]), e.fnServerData ? e.fnServerData.call(s, e.sAjaxSource, t.map(n, (function(t, e) {
                            return {
                                name: e,
                                value: t
                            }
                    ...
                    function gt(t) {
                        t.iDraw++, Bt(t, !0), pt(t, bt(t), (function(e) {
                            vt(t, e)
                        }))
                    }
                    ...
                    function mt(e, n) {
                        ...
                        return "data" === r ? n.aaData || n[r] : "" !== r ? K(r)(n) : n
                    }
                    ...
                    function St(e) {
                        ...
                        var c = t("<div/>", {
                            ...
                            h = t("input", c).val(i.sSearch).attr("placeholder", o.sSearchPlaceholder).on("keyup.DT search.DT input.DT paste.DT cut.DT", d ? Gt(f, d) : f).on("mouseup", (function(t) {
                                setTimeout((function() {
                                    f.call(h[0])
                                }), 10)
                    ...
                    function Ht(t, e) {
                        t._bInitComplete = !0, (e || t.oInit.aaData) && M(t), he(t, null, "plugin-init", [t, e]), he(t, "aoInitComplete", "init", [t, e])
                    }
                    ...
                    function Mt(e) {
                        for (var n = e.oClasses, a = e.sTableId, r = e.aLengthMenu, o = Array.isArray(r[0]), i = o ? r[0] : r, l = o ? r[1] : r, s = t("<select/>", {
                                name: a + "_length",
                                "aria-controls": a,
                    ...
                    function Ut(e) {
                        ...
                        })), t(v).css("max-height", o), a.bCollapse || t(v).css("height", o), e.nScrollHead = b, e.nScrollBody = v, e.nScrollFoot = m, e.aoDrawCallback.push({
                            fn: Vt,
                            sName: "scrolling"
                        }), p[0]
                    }
                    ...
                    function Vt(e) {
                        ...
                        e.scrollBarVis = V, F.children("thead, tfoot").remove(), R && (s = R.clone().prependTo(F), r = R.find("tr"), i = s.find("tr")), l = I.clone().prependTo(F), n = I.find("tr"), o = l.find("tr"), l.find("th, td").removeAttr("tabindex"), h || (C.width = "100%", v[0].style.width = "100%"), t.each(ht(e, l), (function(t, n) {
                            u = k(e, t), n.style.width = e.aoColumns[u].sWidth
                        })), R && Xt((function(t) {
                            t.style.width = ""
                        }), i), f = F.outerWidth(), "" === h ? (P.width = "100%", N && (F.find("tbody").height() > T.offsetHeight || "scroll" == w.css("overflow-y")) && (P.width = Zt(F.outerWidth() - b)), f = F.outerWidth()) : "" !== p && (P.width = Zt(p), f = F.outerWidth()), Xt(U, o), Xt((function(e) {
                            E.push(e.innerHTML), O.push(Zt(t(e).css("width")))
                        }), o), Xt((function(e, n) {
                            -1 !== t.inArray(e, H) && (e.style.width = O[n])
                        }), n), t(o).height(0), R && (Xt(U, i), Xt((function(e) {
                            B.push(e.innerHTML), W.push(Zt(t(e).css("width")))
                        }), i), Xt((function(t, e) {
                            t.style.width = W[e]
                        }), r), t(i).height(0)), Xt((function(t, e) {
                        ...
                        }), i), F.outerWidth() < f ? (c = T.scrollHeight > T.offsetHeight || "scroll" == w.css("overflow-y") ? f + b : f, N && (T.scrollHeight > T.offsetHeight || "scroll" == w.css("overflow-y")) && (P.width = Zt(c - b)), "" !== h && "" === p || se(e, 1, "Possible column misalignment", 6)) : c = "100%", C.width = Zt(c), m.width = Zt(c), R && (e.nScrollFoot.style.width = Zt(c)), g || N && (C.height = Zt(L.offsetHeight + b));
                        var X = F.outerWidth();
                    ...
                    function qt(n) {
                        ...
                        if (S || !v && !c && !u && d == E(n) && d == p.length)
                            for (a = 0; a < d; a++) {
                                ...
                                for (_.find("thead, tfoot").remove(), _.append(t(n.nTHead).clone()).append(t(n.nTFoot).clone()), _.find("tfoot th, tfoot td").css("width", ""), p = ht(n, _.find("thead")[0]), a = 0; a < h.length; a++) r = l[h[a]], p[a].style.width = null !== r.sWidthOrig && "" !== r.sWidthOrig ? Zt(r.sWidthOrig) : "", r.sWidthOrig && c && t(p[a]).append(t("<div/>").css({
                                    width: r.sWidthOrig,
                                    margin: 0,
                                    padding: 0,
                                    border: 0,
                    ...
                    function zt(e, n) {
                        ...
                        if (a < 0) return null;
                        var r = e.aoData[a];
                        return r.nTr ? r.anCells[n] : t("<td/>").html(G(e, a, n, "display"))[0]
                    }

                    function Yt(t, e) {
                        for (var n, a = -1, r = -1, o = 0, i = t.aoData.length; o < i; o++)(n = (n = (n = G(t, o, e, "display") + "").replace(Jt, "")).replace(/&nbsp;/g, " ")).length > a && (a = n.length, r = o);
                        return r
                    }
                    ...
                    function Kt(e) {
                        ...
                        for (Array.isArray(h) && b(h), p && h.pre && b(h.pre), b(e.aaSorting), p && h.post && b(h.post), n = 0; n < g.length; n++)
                            for (r = 0, o = (i = d[c = g[n][0]].aDataSort).length; r < o; r++) u = d[l = i[r]].sType || "string", g[n]._idx === a && (g[n]._idx = t.inArray(g[n][1], d[l].asSorting)), f.push({
                                src: c,
                                col: l,
                                dir: g[n][1],
                                index: g[n]._idx,
                    ...
                    function ne(t, e, n, a) {
                        ...
                        fe(e, {}, (function(e) {
                            !1 !== r.bSortable && (t.oFeatures.bProcessing ? (Bt(t, !0), setTimeout((function() {
                                ee(t, n, e.shiftKey, a), "ssp" !== be(t) && Bt(t, !1)
                            }), 0)) : ee(t, n, e.shiftKey, a))
                        }))
                    }
                    ...
                    function ae(e) {
                        ...
                        if (s.bSort && s.bSortClasses) {
                            for (n = 0, a = o.length; n < a; n++) r = o[n].src, t(y(e.aoData, "anCells", r)).removeClass(i + (n < 2 ? n + 1 : 3));
                            for (n = 0, a = l.length; n < a; n++) r = l[n].src, t(y(e.aoData, "anCells", r)).addClass(i + (n < 2 ? n + 1 : 3))
                        }
                        e.aLastSort = l
                    }
                                    ...
                                    if (-1 === t.inArray(!1, s)) {
                                        ...
                                        if (u > 0 && n.time < +new Date - 1e3 * u) r();
                                            ...
                                            if (e.oLoadedState = t.extend(!0, {}, n), n.start !== a && (e._iDisplayStart = n.start, e.iInitDisplayStart = n.start), n.length !== a && (e._iDisplayLength = n.length), n.order !== a && (e.aaSorting = [], t.each(n.order, (function(t, n) {
                                                ...
                                                }))), n.search !== a && t.extend(e.oPreviousSearch, Lt(n.search)), n.columns)
                    ...
                    function ue(e, n, r, o) {
                        Array.isArray(r) ? t.each(r, (function(t, a) {
                            Array.isArray(a) ? ue(e, n, a[0], a[1]) : ue(e, n, a)
                    ...
                    o = function(e, n) {
                        ...
                        o.register(t, n), o.register(e, (function() {
                            ...
                            return t === this ? this : t instanceof o ? t.length ? Array.isArray(t[0]) ? new o(t.context, t[0]) : t[0] : a : t
                        }))
                    };
                    var Se = function(e, n) {
                    ...
                    i("tables()", (function(t) {
                        return t !== a && null !== t ? new o(Se(t, this.context)) : this
                    })), i("table()", (function(t) {
                        var e = this.tables(t),
                            n = e.context;
                    ...
                    i("rows()", (function(e, n) {
                        ...
                        var n = this.iterator("table", (function(t) {
                                var n, a, r, o = [];
                                for (a = 0, r = e.length; a < r; a++)(n = e[a]).nodeName && "TR" === n.nodeName.toUpperCase() ? o.push(J(t, n)[0]) : o.push(X(t, n));
                                return o
                            }), 1),
                            a = this.rows(-1);
                        ...
                        return n._aData = t, Array.isArray(t) && n.nTr && n.nTr.id && Q(e[0].rowId)(t, n.nTr.id), at(e[0], this[0], "data"), this
                    })), i("row().node()", (function() {
                        var t = this.context;
                        ...
                        var n = this.iterator("table", (function(t) {
                            return e.nodeName && "TR" === e.nodeName.toUpperCase() ? J(t, e)[0] : X(t, e)
                        }));
                        return this.row(n[0])
                    }));
                    var Ce = function(t, e) {
                    ...
                    var Ie = /^([^:]+):(name|visIdx|visible)$/,
                        Fe = function(t, e, n, a, r) {
                            for (var o = [], i = 0, l = r.length; i < l; i++) o.push(G(t, r[i], e));
                            return o
                        };
                    i("columns()", (function(e, n) {
                                ...
                                return De("column", n, (function(n) {
                                    ...
                                    if ("function" == typeof n) {
                                        ...
                                        return t.map(r, (function(t, a) {
                                            return n(a, Fe(e, a, 0, 0, s), i[a]) ? a : null
                                        }))
                                    }
                        ...
                        return e !== a && this.iterator("table", (function(o) {
                            st(o, o.aoHeader), st(o, o.aoFooter), o.aiDisplay.length || t(o.nTBody).find("td[colspan]").attr("colspan", E(o)), oe(o), r.iterator("column", (function(t, a) {
                                he(t, null, "column-visibility", [t, a, e, n])
                    ...
                    i("cells()", (function(e, n, r) {
                        ...
                        return e === a ? 0 !== i.length ? i[0].oPreviousSearch.sSearch : a : this.iterator("table", (function(a) {
                            a.oFeatures.bFilter && yt(a, t.extend({}, a.oPreviousSearch, {
                                sSearch: e + "",
                                bRegex: null !== n && n,
                                bSmart: null === r || r,
                    ...
                    })), s.version = "1.10.25", s.settings = [], s.models = {}, s.models.oSearch = {
                        bCaseInsensitive: !0,
                        sSearch: "",
                        bRegex: !1,
                        bSmart: !0
                        ...
                        renderer: null,
                        rowId: "DT_RowId"
                    }, A(s.defaults), s.defaults.column = {
                        aDataSort: null,
                        iDataSort: -1,
                        asSorting: ["asc", "desc"],
                        bSearchable: !0,
                        ...
                        sType: null,
                        sWidth: null
                    }, A(s.defaults.column), s.models.oSettings = {
                        oFeatures: {
                            bAutoWidth: null,
                            bDeferRender: null,
                            bFilter: null,
                    ...
                    function He(t) {
                        return function() {
                            var e = [le(this[s.ext.iApiIndex])].concat(Array.prototype.slice.call(arguments));
