...
function responsive(e) {
  modalInit || (scrollPos = -1),
    ...
    $("#content, #content > section:only-child").css(
      "min-height",
      winHeight - footerHeight + "px"
    ),
    (dotsWidth = Math.ceil(winWidth / 3)),
    lazySizes.loader.checkElems(),
    e &&
      (winWidth >= breakpoint &&
        ($menu.children(".site-menu").height() + headerHeight + subnavHeight >
        0.75 * winHeight
          ? $menu.attr("data-height", "full")
          : $menu.children(".site-menu").height() +
              headerHeight +
              subnavHeight >
            winHeight / 2
      ...
      $(
        ".portrait-image:not([src]):only-child, .landscape-image:not([src]):only-child"
      ).addClass("lazyload"),
      winWidth > winHeight
        ? $(".portrait-image:not(:only-child)")
            .removeClass("lazyload")
            .siblings(".landscape-image:not([src])")
            .addClass("lazyload")
        : $(".landscape-image:not(:only-child)")
            .removeClass("lazyload")
            .siblings(".portrait-image:not([src])")
            .addClass("lazyload"),
      $("#home-hero").length &&
        safari &&
        $("#home-hero .fullscreen").height(winHeight),
      $("#project-hero").length &&
        ($("#project-hero .fullscreen").height(winHeight),
        $("#project-hero").is(".fall-in")
          ? $("#project-hero").height(winHeight - subnavHeight)
          : $("#project-hero").height(winHeight),
        (heroHeight = $("#project-hero").height())),
      $("#page-hero").length &&
        ((heroMargin = Math.floor(
          (winHeight - $("#hero-text .wrap").innerHeight()) / 2
        )),
        $("#hero-text").css(
          "margin",
          winHeight + "px auto " + heroMargin + "px"
        )),
      $(".subnav-wrap").length &&
        ((subnavPos = Math.floor($(".subnav-wrap").offset().top)),
        ($body.is(".touchscreen") || winWidth < winHeight) &&
          (subnavPos -= headerHeight)),
      $(".slideshow-section").length &&
        ($body.is(".touchscreen") || winWidth < winHeight
          ? $(".slideshow-section .slideshow").height(
              winHeight - headerHeight - subnavHeight
            )
          : $(".slideshow-section .slideshow").height(
              winHeight - subnavHeight
            )),
      ...
      $(".section-view").length > 1 &&
        ($body.is(".touchscreen") || winWidth < breakpoint
          ? $sectionViews.css(
              "min-height",
              winHeight - subnavHeight - headerHeight
            )
          : $sectionViews.css("min-height", winHeight - subnavHeight),
        (secHeight = winHeight - headerHeight - footerHeight),
        $(".post-nav").length && (secHeight -= $(".post-nav").outerHeight()),
        $(".section-view > section:only-of-type").css(
          "min-height",
          secHeight + "px"
        )),
      $projectsGrid.length &&
      ...
      $("#ok-form").length &&
        (winWidth < breakpoint
          ? $("#select-wrap").insertBefore("[data-subject]:first")
          : $("#select-wrap").insertBefore("#message-wrap")));
}
...
function loadVideo(e) {
  if (e.length) {
    ...
    e.is("[data-hd]") &&
      ...
      e.is("[autoplay]") && e.addClass("playing").get(0).play(),
      e.attr("data-loaded", "true");
  }
}

function constant() {
  if (scrollPos === window.pageYOffset || repositioning)
  ...
  if (
    (!modalInit &&
      ...
      scrollInterval % 10 == 0 &&
        (scrollPos >= lastScrollPos
          ...
          : repositioning || $body.removeClass("hide-header"),
        (lastScrollPos = scrollPos))),
    $body.is('[data-loading="true"]')
      ? $("#header-logo").addClass("ok")
      : $("#home-hero").length && scrollPos < winHeight - headerHeight / 2
      ? $("#header-logo").removeClass("ok")
      : $("#header-logo").addClass("ok"),
    $body.is('[data-loading="true"]'))
  )
    ...
    if (0 !== heroHeight) {
      if (
        (($("#project-hero").length &&
          scrollPos >= heroHeight - headerHeight) ||
        ($("#home-hero").length && scrollPos >= heroHeight - headerHeight) ||
        scrollPos >= heroHeight - headerHeight
  ...
  $("#page-hero").length && $("#section-toggle").length
    ? scrollPos >= subnavPos
      ? ($body.addClass("subnav-fixed").removeClass("subnav-fixed-bottom"),
        $("#section-toggle button.active").length ||
          $("#section-toggle button:first").addClass("active"))
      : ($("#page-hero").length &&
          scrollPos < winHeight - heroMargin + headerHeight) ||
        ($("#owner-hero").length && scrollPos < winHeight + headerHeight / 2)
    ...
    $projectsGrid.length &&
      (scrollPos >= subnavPos
        ? ($body.addClass("subnav-fixed"),
          checkedElems || (lazySizes.loader.checkElems(), (checkedElems = !0)))
        : $body.removeClass("subnav-fixed")),
    $("[data-video]:not([data-loaded])").length &&
      $("[data-video]:not([data-loaded])").each(function () {
        ($(this).parents(".section-view").length &&
          !$(this).parents(".section-view").is(".show")) ||
          ...
          scrollPos >= secTopPos - 1.5 * winHeight &&
            scrollPos <= secBot &&
            loadVideo($(this)));
      }),
    scroll(constant);
...
function anchorHook() {
  $("a")
    ...
    .on("click", function (e) {
      ...
      if (
        (e.preventDefault(),
        $(this).is("[data-clear-cookies]") && clearCookies(),
        t.indexOf(".jpg") > -1 ||
          t.indexOf(".jpeg") > -1 ||
          t.indexOf(".png") > -1 ||
          t.indexOf(".gif") > -1)
        ...
        (s = $(this).is("[data-image-index]")
          ? $(
              '#modal-slideshow [data-slide-index="' +
        ...
        if (t.indexOf("#go-back") > -1)
          window.history.back(), $("#error-modal").removeClass("show");
        else if (t.indexOf("#") > -1) {
          if (
            ...
            return (
              targetAnchor.slideDown(transTime),
              $(this).parents(".button-wrap").slideUp(transTime),
              !1
            );
          if (targetAnchor.is(".section-view")) {
            ...
            targetPage &&
              ...
              (e.preventDefault(), loadWrap(t));
          }
        } else {
          if (
            t === currentState ||
            (currentState.indexOf("#") > -1 &&
              t === currentState.split("#")[0]) ||
            (currentState.indexOf("?") > -1 &&
              t === currentState.split("?")[0] &&
          ...
          if ($(this).is("[data-cover]") && !safari) {
            ...
            var n = !1;
            $(this).find(".landscape-image").length &&
            $(this).find(".portrait-image").length
              ? (($(this).attr("data-cover") ===
                  $(this).find(".landscape-image").attr("data-id") &&
                  winWidth > winHeight) ||
                  ($(this).attr("data-cover") ===
                    $(this).find(".portrait-image").attr("data-id") &&
                    winHeight > winWidth)) &&
                (n = !0)
              : (($(this).find(".landscape-image").length &&
                  $(this).attr("data-cover") ===
              ...
              n
                ? ($(this)
                    ...
                    .hide()
                    .appendTo($body)
                    .addClass("offblack-bg white-text")
                    .attr("id", "transition-cover")
                    .fadeIn(transTime)
                    .find("a")
                    .removeAttr("href"),
                  setTimeout(function () {
            ...
            $(this).is('[rel="nofollow"]')
              ? window.open(
                  t,
                  "t",
                  "toolbar=0,resizable=1,status=0,width=600,height=500"
                )
              : i.test(this.href) && !$(this).is(".post-edit-link")
              ? loadWrap(t)
              : -1 === t.indexOf("javascript") &&
                (e.stopPropagation(), window.open(this.href, "_blank"));
        }
      }
    });
}
...
function closeModal(e) {
  (modalInit = !1),
    ...
    $(".modal.show").length ||
      ($body.removeClass("modal-open"), $(document).scrollTop(scrollPos));
}
    ...
    $body.is(".touchscreen") ||
      (setOpen = setTimeout(function () {
        $body.addClass("modal-open"),
          ...
          "#slideshow-modal" !== e ||
            $body.is(".touchscreen") ||
            $("#slideshow-modal").find(".slick-active button").focus();
      }, transTime)),
    modalCount++;
}
...
function cleanUp() {
  $('iframe[src*="player.vimeo.com"]').each(function () {
    ...
    e && e.indexOf("?") > -1 && (e = e.split("?")[0]),
      (e += "?portrait=0&badge=0&byline=0&color=ea0000"),
      $(this).attr("src", e);
  }),
    $("p, .wrap, .flexible-section").each(function () {
      var e = $(this);
      0 === e.html().replace(/\s|&nbsp;/g, "").length &&
        (e.parents("ul.project-team").length
          ? e.parent("li").remove()
          : e.remove());
    }),
    iOSSafari ||
...
function setupSlideshows() {
  $("#slideshow-modal")
    .empty()
    .append(
      '<div class="slideshow" id="modal-slideshow"></div><button class="modal-close"></button>'
    ),
    $('a[href$=".jpg"],a[href$=".jpeg"],a[href$=".png"],a[href$=".gif"]').each(
      function () {
        $(this).is("[data-image-index]")
          ...
          : $(
              '<div class="slide"><div class="slide-image"><img src="' +
                $(this).attr("href") +
                '" /></div></div>'
            ).appendTo("#modal-slideshow");
      }
  ...
  $(".slideshow").each(function () {
    ($(this).parents(".section-view").length &&
      ...
      ($(this).is(".slick-initialized")
        ...
        : (($(this).parents("#project-hero").length ||
            $(this).parents(".slideshow-section").length) &&
            ...
            .on("beforeChange", function (e, t, i, s) {
              if (
                ...
                $(this)
                  ...
                  .removeClass("hidden"),
                $(this).find('[data-slick-index="' + s + '"] video').length &&
                  loadVideo(
                    $(this).find('[data-slick-index="' + s + '"] video')
                  ),
                ...
                o > dotsWidth && s !== n
                  ? $(this)
                      ...
                      .css({
                        transform:
                          "translateX(" + Math.round(dotsWidth - o) + "px)",
                        "-webkit-transform":
                          "translateX(" + Math.round(dotsWidth - o) + "px)",
                      })
                  : s === n
                  ? $(this)
                      ...
                      .css({
                        transform:
                          "translateX(" +
                          Math.round(dotsWidth - o + dotWidth) +
                          "px)",
                        "-webkit-transform":
                          "translateX(" +
                          Math.round(dotsWidth - o + dotWidth) +
...
function initialize(e) {
  if (
    ...
    $("#home-hero").length &&
      ...
      $("#home-hero .fullscreen a").each(function () {
        $(this)
          .clone()
          .addClass("fullscreen fix")
          .empty()
          .appendTo("#safari-fix");
      }),
    $(".admin-edit").length &&
      $(".admin-edit").hide().appendTo($body).fadeIn(transTime),
    cleanUp(),
    responsive(!1),
    $("select").chosen({
    ...
    $("#project-hero").length &&
      ($("#transition-cover").length
        ? ($("#project-hero h1").html($("#transition-cover h1").html()),
          $("#transition-cover button")
            .clone()
            .appendTo("#project-hero .text-wrap"),
          setTimeout(function () {
            responsive(!0),
      ...
      setTimeout(function () {
        $("#project-hero").addClass("fell-in"),
          $body.is(".touchscreen") ||
            $("#project-hero .slick-active button").focus(),
          $("#project-hero .slide-text").remove();
      }, 5 * transTime),
      "" !== projectsList ||
        $.isArray(projectsList) ||
        Cookies.get("project-list")))
  ) {
    "" === projectsList || $.isArray(projectsList)
      ? Cookies.get("project-list") &&
        (projectsList = Cookies.get("project-list").split(",").map(Number))
      : (projectsList = projectsList.split(",").map(Number)),
      ...
      if (
        (projectsList.length > 0
          ? (0 === s
              ...
              : $("#prev-link").attr(
                  "href",
                  homeURL + "/?p=" + projectsList[s - 1]
                ),
            s === projectsList.length - 1
        ...
        for (i = 0; i < cookieFilters.length; i++)
          "sort" !== (filterName = cookieFilters[i].split("=")[0]) &&
            $("#projects-nav #project-" + filterName).text(
              filterName + ": " + cookieFilters[i].split("=")[1]
            );
    } else clearCookies();
  }
  var o, n;
  $sectionViews.length
    ? $(".section-view").length > 1
      ? ($sectionViews.next().length &&
          $sectionViews.next().hide().clone().appendTo(".section-view").show(),
        ...
        $(window.location.hash).is(".section-view")
          ? (setTimeout(function () {
              window.scrollTo(0, 0);
            }, 1),
            setTimeout(function () {
              (o = $(window.location.hash).index() + 1),
                $(document).scrollTop(subnavPos),
                $("#section-toggle button:nth-child(" + o + ")").trigger(
                  "click"
                );
            }, 2))
  ...
  $(".video-wrap").length &&
    $(".video-wrap").each(function () {
      $(this)
        ...
        $(this).is(".autoplay") &&
          !1 !== $(this).siblings("video").get(0) &&
          $(this).removeClass("autoplay").find(".play-toggle").trigger("click");
    });
  $("#ok-form").length &&
    ($("[data-subject], .hidden-fields").hide(),
    $(".input-wrap input, .input-wrap textarea").on(
      "load focusout",
      function () {
        "" !== $(this).val()
    ...
    $("#form-subject").on("change", function () {
      $('[data-subject]:not([data-subject="' + this.value + '"]').slideUp(
        transTime,
        function () {
          $(this)
            .find("input")
        ...
        $('[data-subject="' + this.value + '"]').slideDown(
          transTime,
          function () {
            $(this)
              .find("input")
              .attr("name", "extra-field")
              .attr("id", "extra-field")
              .siblings("label")
              .attr("for", "extra-field");
          }
        ),
        $("#send_to").val($(this).find(":selected").data("email")),
        $("#extra_label").val(
          $('[data-subject="' + this.value + '"] label').text()
        );
    }),
    $("#ok-form").submit(function (e) {
      e.preventDefault(),
        $("#send-form").val("Sending...").attr("disabled", "true");
      ...
      $("#form-response").text(""),
        $.ajax({
          ...
          .fail(function (e) {
            $("#send-form").val("Try Again").removeAttr("disabled"),
              "" !== e.responseText
                ? $("#form-response").text(e.responseText)
                : $("#form-response").text("Please try button again!");
          });
    })),
    anchorHook(),
...
function alignToSubnav() {
  scrollPos < subnavPos
    ...
    : ((repositioning = !0),
      ...
      setTimeout(function () {
        (scrollPos = subnavPos + 1),
          (lastScrollPos = subnavPos + 1),
          (repositioning = !1);
      }, transTime + 1));
}
...
function initProjects() {
  $projectsGrid.css(
    "min-height",
    winHeight - headerHeight + subnavHeight - footerHeight + "px"
  ),
    ($body.is(".touchscreen") || winWidth < breakpoint) &&
      $('#project-filters option[value="all"]')
        .each(function () {
          (filterName = $(this).parents("select").attr("id").split("-")[1]),
            $(this).html(
              "All " +
    ...
    $.ajax(homeURL + "/home/projects/").done(function (e) {
      $("#projects-grid").html(e),
        ...
        Cookies.get("project-list")
          ? ((storedProjectsList = Cookies.get("project-list")),
            (storedListSet = !1))
          : "" !== projectsList
          ? ((storedProjectsList = projectsList), (storedListSet = !1))
          : (storedProjectsList = "");
      var t = !1;
      if (
        ...
        $("#project-filters select").on("change", function () {
          t && ((storedListSet = !0), alignToSubnav()),
            filterGrid(),
            $(this).next(".chosen-container").attr("data-value", $(this).val());
        }),
          ...
          $projectsGrid.addClass("filtering"),
            $("#projects-sort").is(".active")
              ? ($("#projects-sort").removeClass("active"),
                setTimeout(function () {
                  sortProjects(
                    "" === filterAttrs ? "position" : "last-position"
                  );
                }, transTime / 2))
        ...
        $("#projects-sort").is(".set-active") &&
          (clearCookies(),
          "" === storedProjectsList && sortProjects("title"),
          $("#projects-sort").removeClass("set-active").addClass("active")),
        Cookies.getJSON("filters") &&
          (cookieFilters = Cookies.getJSON("filters")).length > -1)
      )
        for (i = 0; i < cookieFilters.length; i++)
          "sort" === (filterName = cookieFilters[i].split("=")[0])
...
function makeCookies() {
  if (
    ...
    for (
      ...
      updateQueryString(
        (filterName = cookieFilters[i].split("=")[0]),
        cookieFilters[i].split("=")[1]
      ),
        "sort" !== filterName &&
          $(
            '#project-filters select:not([id="select-' + filterName + '"])'
          ).each(function () {
            "all" === $(this).val() &&
      ...
      if ("" === storedProjectsList || storedListSet)
        "" === filterAttrs
          ? ($projects.addClass("show"),
            $("#projects-sort").is("active")
              ? sortProjects("title")
              : sortProjects("position"),
            (itemCount = $("#projects-grid .grid-item").length))
          : ($projects.each(function () {
              $(this).removeClass("show"),
                $(this).is(filterAttrs) &&
                  (itemCount++,
                  $(this)
                    .attr("data-last-position", itemCount)
                    .addClass("show"));
            }),
            $("#projects-sort").is("active")
              ? sortProjects("title")
              : sortProjects("last-position"),
            0 === itemCount
              ? $("#no-projects").addClass("show")
              : $("#no-projects").removeClass("show"));
      else {
        if (
          (console.log("storedProjectsList", storedProjectsList),
          $.isArray(storedProjectsList) ||
            (storedProjectsList = storedProjectsList.split(",").map(Number)),
            ...
            $.ajax(e)
              .done(function (t) {
                $contentWrap.html($(t).find("#content")),
                  ...
                  (currentState = $("#content").is("[data-url]")
              ...
              .fail(function (t, i) {
                ++attempts < 7
                  ? setTimeout(loadWrap(e), 1e3)
                  : (openModal("#error-modal"), $header.addClass("opaque"));
              });
        }, transTime));
}
...
!(function (e, t) {
  ...
  if (i.getElementsByClassName) {
    ...
    var N =
        ...
        (oe = function (e) {
          ie--,
            e && e.target && b(e.target, oe),
            (!e || ie < 0 || !e.target) && (ie = 0);
        }),
        (ne = function (e) {
          return (
            null == K && (K = "hidden" == S(i.body, "visibility")),
            K ||
              ("hidden" != S(e.parentNode, "visibility") &&
                "hidden" != S(e, "visibility"))
          );
        }),
        (re = function (e, t) {
          var s,
          ...
          for (
            X -= t, V += t, G -= t, Y += t;
            r && (o = o.offsetParent) && o != i.body && o != n;
          ...
          if ((F = o.loadMode) && ie < 8 && (e = m.length)) {
            for (
                  ...
                  (p =
                    !o.expand || o.expand < 1
                      ? n.clientHeight > 500 && n.clientWidth > 500
                        ? 500
                        : 370
                      : o.expand) * o.expFactor,
                g = o.hFac,
                K = null,
                te < f && ie < 1 && se > 2 && F > 2 && !i.hidden
                  ? ((te = f), (se = 0))
                  : (te = F > 1 && se > 1 && ie < 6 ? p : 0);
              t < e;
              t++
            )
              if (m[t] && !m[t]._lazyRace)
                if (Z)
                  if (
                    (((h = m[t].getAttribute("data-expand")) && (c = 1 * h)) ||
                      (c = te),
                    u !== c &&
                      ((B = innerWidth + c * g),
                      (U = innerHeight + c),
                      ...
                      (I[0] ||
                        (!h &&
                          (V ||
                            ...
                            G ||
                            X ||
                            "auto" != m[t].getAttribute(o.sizesAttr)))) &&
                      (l = I[0] || m[t]);
                else ge(m[t]);
            l && !a && ge(l);
          }
        ...
        (de = L(
          (ce = function (e) {
            w(e.target, o.loadedClass),
              y(e.target, o.loadingClass),
              b(e.target, he),
              k(e.target, "lazyloaded");
          })
        )),
        (he = function (e) {
          de({
        ...
        (fe = L(function (e, t, i, s, n) {
          ...
          (d = k(e, "lazybeforeunveil", t)).defaultPrevented ||
            ...
            l
              ...
              : r && !c && (Q.test(e.nodeName) ? ue(e, r) : (e.src = r)),
            n &&
              (l || c) &&
              T(e, {
                src: r,
        ...
        }),
        {
          _: function () {
            (R = r.now()),
              ...
              t.MutationObserver
                ...
                : (n.addEventListener("DOMNodeInserted", ae, !0),
                  n.addEventListener("DOMAttrModified", ae, !0),
                  setInterval(ae, 999)),
              d("hashchange", ae, !0),
              [
                "focus",
              ...
              /d$|^c/.test(i.readyState)
                ? me()
                : (d("load", me),
                  i.addEventListener("DOMContentLoaded", ae),
                  h(me, 2e4)),
          ...
          unveil: (ge = function (e) {
            ...
            ((!n && D) ||
              ...
              n && ve.updateElem(e, !0, e.offsetWidth),
              (e._lazyRace = !0),
              ie++,
              fe(e, t, n, s, i));
          }),
      ...
      ve =
        ((we = L(function (e, t, i, s) {
          ...
          if (
            ...
            for (
              n = 0, r = (o = t.getElementsByTagName("source")).length;
              n < r;
              n++
            )
...
var objectFitImages = (function () {
  ...
  function i(e) {
    for (
      var t = getComputedStyle(e).fontFamily, i, s = {};
      null !== (i = d.exec(t));
  ...
  function n(e) {
    ...
    t(l.img),
      (e.style.backgroundImage =
        'url("' + (l.img.currentSrc || l.img.src).replace(/"/g, '\\"') + '")'),
      (e.style.backgroundPosition = n["object-position"] || "center"),
      (e.style.backgroundRepeat = "no-repeat"),
      (e.style.backgroundOrigin = "content-box"),
      /scale-down/.test(n["object-fit"])
        ? o(l.img, function () {
            l.img.naturalWidth > e.width || l.img.naturalHeight > e.height
  ...
  function r(e) {
    var t = {
      ...
      set: function t(i, s) {
        return (
          (e[c].img[s || "src"] = i), v.call(e, "data-ofi-" + s, i), n(e), i
        );
      },
    };
...
!(function (e, t) {
  ...
  function l(e, i) {
    ...
    if (e.nodeType === e.ELEMENT_NODE)
      ...
      e.nodeType === e.COMMENT_NODE
        ? (C += e.length + 7)
        : e.nodeType === e.PROCESSING_INSTRUCTION_NODE
        ? (C += e.length + 2)
        : (C += e.length);
  }
  ...
  function c(e) {
    ...
    t(i, function (e) {
      ...
      t(
        (i = e.querySelectorAll('br[data-owner="balance-text"]')),
        function (e) {
          e.outerHTML = " ";
        }
      );
    ...
    if (
      ...
      (s = e.querySelectorAll('span[data-owner="balance-text-justify"]'))
        .length > 0)
    ) {
      var o = "";
      t(s, function (e) {
  ...
  function h(e, t) {
    var i = /([^\S\u00a0]|-|\u2014|\u2013|\u00ad)(?![^<]*>)/g,
      s;
    if (!T)
      for (T = [], s = i.exec(e); null !== s; )
        r(s.index) || T.push(s.index), (s = i.exec(e));
        ...
        for (
          ...
          (T = null),
            ...
            p(
              ...
              _,
              h,
              (x = Math.round((g + v) / S - v)),
              -1,
              (j = Math.round((_.length + 1) / S) - 1),
              (H = new n())
            ),
            (P = new n()),
            ...
            (O =
              0 === H.index
                ...
                : h < P.width ||
                  H.index === P.index ||
                  Math.abs(x - H.width) < Math.abs(P.width - x)
                ? H.index
                : P.index),
  ...
  function _() {
    j ||
      ...
      window.addEventListener("resize", s(v)),
      (j = !0));
  }
  ...
  var A = function (e) {
    ...
    return (
      "justify" ===
      (e.currentStyle || window.getComputedStyle(e, null)).textAlign
    );
  };
      ...
      (t = (function () {
        ...
        return (
            ...
            for (
              ...
              "" !==
                (s = (i = r[o]).group
                  ...
                  : this.result_add_option(i)) && (l++, (t += s)),
          ...
          (e.prototype.get_search_regex = function (e) {
            var t, i;
            return (
              (i = this.search_contains ? e : "(^|\\s|\\b)" + e + "[^\\s]*"),
              this.enable_split_word_search ||
          ...
          (e.prototype.choices_count = function () {
            ...
            for (
              this.selected_option_count = 0,
                e = 0,
                t = (i = this.form_field.options).length;
              e < t;
              e++
            )
          ...
          return t.browser_is_supported()
            ? this.each(function (t) {
                ...
                (n = (o = e(this)).data("chosen")),
                  "destroy" !== s
                    ? n instanceof i || o.data("chosen", new i(this, s))
                    : n instanceof i && n.destroy();
              })
            : this;
        },
      }),
        ...
        return (
          ...
          (o.prototype.container_mousedown = function (t) {
            ...
            if (!this.is_disabled)
              return (
                !t ||
                  ("mousedown" !== (i = t.type) && "touchstart" !== i) ||
                  this.results_showing ||
                  t.preventDefault(),
          ...
          (o.prototype.test_active_click = function (t) {
            var i;
            return (i = e(t.target).closest(".chosen-container")).length &&
              ...
              if (
                ...
                (t =
                  (i =
                    ...
                    this.search_results.scrollTop()) +
                  this.result_highlight.outerHeight()) >= o)
              )
          ...
          (o.prototype.search_results_mouseup = function (t) {
            var i;
            if (
              (i = e(t.target).hasClass("active-result")
                ? e(t.target)
          ...
          (o.prototype.search_field_scale = function () {
            ...
            if (this.is_multiple) {
              ...
              return (
                (t = e("<div />").css(n)).text(this.get_search_field_value()),
                e("body").append(t),
                (l = t.width() + 25),
                t.remove(),
    ...
    (e = (function () {
      ...
      (e.prototype.buildDots = function () {
        ...
        if (!0 === e.options.dots && e.slideCount > e.options.slidesToShow) {
          for (
            ...
            i.append(
              $("<li />").append(e.options.customPaging.call(this, e, t))
            );
      ...
      (e.prototype.buildOut = function () {
        ...
        (e.$slides = e.$slider
          ...
          (e.$slideTrack =
            0 === e.slideCount
              ? $('<div class="slick-track"/>').appendTo(e.$slider)
      ...
      (e.prototype.checkResponsive = function (e, t) {
        ...
        if (
          ("window" === i.respondTo
            ...
            : "slider" === i.respondTo
            ? (n = l)
            : "min" === i.respondTo && (n = Math.min(a, l)),
          i.options.responsive &&
            i.options.responsive.length &&
            null !== i.options.responsive)
        ) {
          for (s in ((o = null), i.breakpoints))
            i.breakpoints.hasOwnProperty(s) &&
              (!1 === i.originalSettings.mobileFirst
                ? n < i.breakpoints[s] && (o = i.breakpoints[s])
                : n > i.breakpoints[s] && (o = i.breakpoints[s]));
          null !== o
            ? null !== i.activeBreakpoint
              ? (o !== i.activeBreakpoint || t) &&
                ((i.activeBreakpoint = o),
                "unslick" === i.breakpointSettings[o]
                  ? i.unslick(o)
                  : ((i.options = $.extend(
                      {},
                      i.originalSettings,
                      i.breakpointSettings[o]
                    )),
      ...
      (e.prototype.changeSlide = function (e, t) {
        ...
        switch (
          ...
          (o = (r = i.slideCount % i.options.slidesToScroll != 0)
            ? 0
          ...
          case "index":
            ...
            i.slideHandler(i.checkNavigable(l), !1, t),
      ...
      (e.prototype.checkNavigable = function (e) {
        var t, i, s;
        if (((s = 0), e > (i = this.getNavigableIndexes())[i.length - 1]))
          e = i[i.length - 1];
        else
          for (var o in i) {
            if (e < i[o]) {
      ...
      (e.prototype.cleanUpEvents = function () {
        ...
        e.options.dots &&
          ...
          ($("li", e.$dots)
            ...
            .off("mouseenter.slick", $.proxy(e.interrupt, e, !0))
            .off("mouseleave.slick", $.proxy(e.interrupt, e, !1)),
          ...
          !0 === e.options.focusOnSelect &&
            $(e.$slideTrack).children().off("click.slick", e.selectHandler),
          $(window).off(
        ...
        return (
              ...
              t.slideCount % t.options.slidesToScroll != 0 &&
                ...
                (e > t.slideCount
                  ? ((t.slideOffset =
                      ...
                      -1),
                    (o =
                      (t.options.slidesToShow - (e - t.slideCount)) * s * -1))
                  : ((t.slideOffset =
          ...
          !0 === t.options.variableWidth &&
            ...
            (i =
              !0 === t.options.rtl
                ? n[0]
                  ? -1 * (t.$slideTrack.width() - n[0].offsetLeft - n.width())
                  : 0
                : n[0]
                ? -1 * n[0].offsetLeft
                : 0),
          ...
          !0 === e.options.swipeToSlide
            ? (e.$slideTrack.find(".slick-slide").each(function (t, o) {
                ...
                if (
                  ((n = $(o).outerWidth()),
                  (r = o.offsetLeft),
                  !0 !== e.options.centerMode && (r += n / 2),
                  s < (l = r + n))
                )
                  return (i = o), !1;
              }),
              (t =
                Math.abs($(i).attr("data-slick-index") - e.currentSlide) || 1))
            : e.options.slidesToScroll
        );
      }),
      ...
      (e.prototype.initDotEvents = function () {
        ...
        !0 === e.options.dots &&
          ...
          !0 === e.options.dots &&
            ...
            e.slideCount > e.options.slidesToShow &&
            $("li", e.$dots)
              .on("mouseenter.slick", $.proxy(e.interrupt, e, !0))
              .on("mouseleave.slick", $.proxy(e.interrupt, e, !1));
      }),
      (e.prototype.initSlideEvents = function () {
        var e = this;
        e.options.pauseOnHover &&
          (e.$list.on("mouseenter.slick", $.proxy(e.interrupt, e, !0)),
      ...
      (e.prototype.initializeEvents = function () {
        ...
        e.initArrowEvents(),
          ...
          !0 === e.options.focusOnSelect &&
            $(e.$slideTrack).children().on("click.slick", e.selectHandler),
          $(window).on(
            "orientationchange.slick.slick-" + e.instanceUid,
            $.proxy(e.orientationChange, e)
          ),
          $(window).on(
            "resize.slick.slick-" + e.instanceUid,
            $.proxy(e.resize, e)
          ),
          $("[draggable!=true]", e.$slideTrack).on(
            "dragstart",
            e.preventDefault
          ),
        ...
        if (
          (!0 === t.options.centerMode
            ...
            : ((o = t.options.infinite
                ...
                : t.currentSlide),
              (n = Math.ceil(o + t.options.slidesToShow)),
              !0 === t.options.fade &&
                (o > 0 && o--, n <= t.slideCount && n++)),
          (i = t.$slider.find(".slick-slide").slice(o, n)),
          "anticipated" === t.options.lazyLoad)
        )
          for (
            var r = o - 1, l = n, a = t.$slider.find(".slick-slide"), c = 0;
            c < t.options.slidesToScroll;
            c++
          )
            r < 0 && (r = t.slideCount - 1),
        ...
        t.unslicked ||
          ...
          !0 === t.options.accessibility &&
            ...
            t.options.focusOnChange &&
              $(t.$slides.get(t.currentSlide)).attr("tabindex", 0).focus()));
      }),
          ...
          if (
            ...
            for (n in l)
              if ("array" !== $.type(s.options.responsive))
                s.options.responsive = [l[n]];
              else {
                for (o = s.options.responsive.length - 1; o >= 0; )
                  s.options.responsive[o].breakpoint === l[n].breakpoint &&
        ...
        if (
          ...
          (i = Math.floor(t.options.slidesToShow / 2)),
            !0 === t.options.infinite &&
              ...
              0 === e
                ? s
                    .eq(s.length - 1 - t.options.slidesToShow)
      ...
      (e.prototype.setupInfinite = function () {
        ...
        if (
          ...
          !0 === e.options.infinite &&
            !1 === e.options.fade &&
            ((i = null), e.slideCount > e.options.slidesToShow))
        ) {
          for (
            s =
              !0 === e.options.centerMode
      ...
      (e.prototype.selectHandler = function (e) {
        var t = this,
          i = $(e.target).is(".slick-slide")
            ? $(e.target)
            : $(e.target).parents(".slick-slide"),
        ...
        if (
          ...
          if (
            ...
            if (
              ...
              a.options.asNavFor &&
                (c = (c = a.getNavTarget()).slick("getSlick")).slideCount <=
                  c.options.slidesToShow &&
                c.setSlideClasses(a.currentSlide),
              a.updateDots(),
              a.updateArrows(),
              !0 === a.options.fade)
            )
            ...
            !t.options.verticalSwiping && !t.swiping && a > 4
              ...
              : (!0 === t.options.verticalSwiping &&
                ...
                !1 === t.options.vertical
                  ? (t.swipeLeft = s + n * r)
                  : (t.swipeLeft =
                      s + n * (t.$list.height() / t.listWidth) * r),
        ...
        for (r = 0; r < n; r++)
          if (
            ("object" == typeof s || void 0 === s
              ? (i[r].slick = new e(i[r], s))
              : (l = i[r].slick[s].apply(i[r].slick, o)),
            void 0 !== l)
          )
            return l;
        return i;
  ...
  (function (e) {
    ...
    function n(e) {
      var i = e.keyCode,
        s,
        o = t(x, i);
      if ((o >= 0 && x.splice(o, 1), (93 != i && 224 != i) || (i = 91), i in b))
        for (s in ((b[i] = !1), T)) T[s] == i && (l[s] = !1);
    }
    ...
    function l(e, t, i) {
      ...
      for (var n = 0; n < s.length; n++)
        (o = []),
          (e = s[n].split("+")).length > 1 &&
            ((o = m(e)), (e = [e[e.length - 1]])),
          (e = e[0]),
          (e = C(e)) in y || (y[e] = []),
          y[e].push({
            shortcut: s[n],
    ...
    function a(e, t) {
      ...
      for (s = g(e), l = 0; l < s.length; l++) {
        if (
          ...
          return;
        for (r = 0; r < y[e].length; r++)
          (a = y[e][r]).scope === t && i(a.mods, n) && (y[e][r] = {});
      }
    }
    ...
    function f(e) {
      var t, i, s;
      for (t in y)
        for (i = y[t], s = 0; s < i.length; )
          i[s].scope === e ? i.splice(s, 1) : s++;
    }
        ...
        request: function (t) {
          ...
          (t = t || e.documentElement),
            / Version\/5\.1(?:\.\d+)? Safari\//.test(navigator.userAgent)
              ? t[o]()
              : t[o](i ? Element.ALLOW_KEYBOARD_INPUT : {});
        },
        exit: function () {
          e[s.exitFullscreen]();
        },
  ...
  clearTimeout(lazyInitThrottle),
    (lazyInitThrottle = setTimeout(function () {
      !iPad &&
        ...
        $(e.target).parents(".slick-slide").next().find(".slide-image.hidden")
          .length &&
        $(e.target)
          .parents(".slick-slide")
          .next()
...
$(document).ready(function () {
  var e;
  analyticsID &&
    (gaTracker(analyticsID), gaTrack(currentState, pageName.split(" â€” ")[1])),
    responsive(!1),
    $footer.hide(),
      ...
      if (27 === e.keyCode)
        if ($(".modal.show").length) {
          ...
          $(".modal.show").each(function () {
            $(this).attr("data-modal-count") > t &&
              (t = $(this).attr("data-modal-count"));
          });
      ...
      key("tab", function () {
        $(document.activeElement).parents("#home-hero").length
          ? $htmlBody.stop().animate(
              {
                scrollTop:
                  ($(document.activeElement).parents(".fullscreen").index() +
                    1) *
                  winHeight,
              },
              transTime
          ...
          : $(document.activeElement).parents(".section-view").length &&
            ...
            $(
              "#section-toggle button:nth-child(" +
                $(document.activeElement).parents(".section-view").index() +
                "1)"
            ).trigger("click");
      });
  }),
  window.addEventListener(
    ...
    function (e) {
      if (e.state) {
        var t = e.state.path;
        isPopState || -1 !== t.indexOf("?s=")
          ? null !== e.state && (window.location = t)
          : (e.preventDefault(),
            (isPopState = !0),
            null !== e.state && loadWrap(t),
  ...
  $(window).on("resize", function () {
    iOSSafari && $(window).width() !== winWidth
      ? responsive(!0)
      : iOSSafari || responsive(!0);
  }),
  window.addEventListener(
    "orientationchange",
    function () {
