            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h4 class="mb-2 text-center">Two Step Verification 
                            <!--💬-->
                        </h4>
                        ...
                        <p class="text-center mb-4">
                            ...
                            <span class="fw-bold d-block mt-2"><?php echo substr_replace($this->session->userdata('custotplogin'), "********", 3, 10); ?></span>
                        ...
                        <form id="twoStepsForm" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="auth-input-wrapper d-flex align-items-center justify-content-sm-between numeral-mask-wrapper">
                                    ...
                                    <input type="hidden" id="custotplogin" name="custotplogin" value="<?php echo base64_encode($this->session->userdata('custotplogin')); ?>" class="form-control">
                            ...
                            <button id="verify-otp" class="btn btn-primary d-grid w-100 mb-3">
                            ...
                            <div class="text-center">Didn't get the code?
                                ...
                                <a href="javascript:void(0);" class="resend-otp" data-id="login_otp">
