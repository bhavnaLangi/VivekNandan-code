...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h5 class="card-header p-0">Login History</h5>
...
if($elapsed5 > 0) {echo $elapsed5; if($elapsed5 > 1){echo 'seconds ';} else { echo 'second '; } }
                       ...
                       <!-- <td><?php //echo $row1['exit_page'];?></td>  -->
                        ...
                        <td><?php  if($row1['status'] ==1){echo 'Active';}else{ echo 'Deactive';};
                                ...
                                if( $row1['status']==1 ) {
                                    ?>
                            <a class="btn btn-primary mr-1" href="<?php echo base_url();?>logoutdevice/<?php echo $row1['id'] ; $this->session->set_userdata('logoutid',$row1['id']);?>">Logout</a>
                            <?php
