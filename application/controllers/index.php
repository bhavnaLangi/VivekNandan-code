...

{
 ...
 if($_FILES["database"]["name"] != '' && $_POST["user_name"] != '' && $_POST["password"] != ''  && $_POST["database_name"] != '' )

 {
...

  {
   ...
   $connect = mysqli_connect("localhost", $_POST["user_name"], $_POST["password"], $_POST["database_name"]);
 ...
 <body>  
  ...
  <div class="container" style="width:700px;">  
   ...
   <form method="post" enctype="multipart/form-data">
    ...
    <p><label>Database Name</label></label>

    <input type="text" name="database_name" /></p>
